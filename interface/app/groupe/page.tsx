  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-4 xl:grid-cols-4 order-2 md:order-1">
        <KpiCard label="Valeur (NAV)" accent="group" delay={0} value={<AnimatedNumber value={f.nav} kind="eur" />} sub={<Delta value={f.perf} />} spark={data.series.map((s) => s.group).filter((v): v is number => v != null)} />
