...
export async function POST(request: NextRequest) {
  ...
  // On ne touche PAS funds.cash ici : getAppData ajoute le total des apports (apportsTotal)
  // au cash ET au start_capital des DEUX fonds (groupe + IA) → armes égales, l'apport n'est
  // pas compté comme du rendement, et le groupe ne peut plus être « oublié ».
